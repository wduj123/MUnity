// ========================================================
// 描 述：SplineTrailRenderer.cs 
// 作 者：郑贤春 
// 时 间：2017/02/10 10:41:19 
// 版 本：5.4.1f1 
// ========================================================
using UnityEngine;
...
namespace GG.Effect
{
    ...
    public class SplineTrailRenderer : MonoBehaviour
    {
        ...
        {
            public int baseNbQuad = 50;
            public int nbQuadIncrement = 20;
            ...
            //0 means fadeDistance and should suffice, but you can
            //redraw a smaller section when there is no fade as an
            //optimization
            public bool shiftMeshData = false;
            //optimization to prevent memory shortage on very long
        ...
        public void ImitateTrail(SplineTrailRenderer trail)
        {
            ...
            GetComponent<Renderer>().material = trail.GetComponent<Renderer>().sharedMaterial;
        }
